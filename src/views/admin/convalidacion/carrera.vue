<template>
    <div class="card">
        <h4 style="color: blue; text-align: center;">CONVALIDACIÓN DE MATERIAS DE CARRERA A CARRERA</h4><br><br>
...
import { convalidacion02 } from '../js/convalidacionCarrera';
...
function generatePDF() {
    ...
    doc.setFontSize(12);
    doc.text('Reporte de Convalidacion de Materias de Carrera a Carrera', 12, y + imgHeight + 10);
    ...
    // Save the PDF
    doc.save('reporte_convalidacion_carrera.pdf');
}
</script>
