<template>
    <div class="card">
        <h4 style="color: blue; text-align: center;">CONVALIDACIÓN DE MATERIAS DE PLAN A PLAN</h4><br><br>
...
import { convalidacion01 } from '../js/convalidacionPlanPlan';
...
function generatePDF() {
    ...
    doc.setFontSize(12);
    doc.text('Reporte de Convalidacion de Materias de Plan a Plan', 12, y + imgHeight + 10);
    ...
    // Save the PDF
    doc.save('reporte_convalidacion_plan.pdf');
}
</script>
