<template>
    <div class="card">
        <h4 style="color: blue; text-align: center;">ALUMNOS SOLICITANTES DE CERTIFICADO DE CONCLUSION DE ESTUDIOS</h4><br><br>
...
import { certificadosC } from '../js/certificadoConclusion';
...
function generatePDF() {
    ...
    doc.setFontSize(12);
    doc.text('Reporte de Alumnos Solicitando el Certificado de Conclusion de Estudios', 12, y + imgHeight + 10);
    ...
    // Save the PDF
    doc.save('reporte_certificado_ConclusionEstudios.pdf');
}
</script>
