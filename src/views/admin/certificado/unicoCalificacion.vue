<template>
    <div class="card">
        <h4 style="color: blue; text-align: center;">ALUMNOS SOLICITANTES DE CERTIFICADO UNICO DE CALIFICACIONES</h4><br><br>
...
import { certificadosU } from '../js/certificadoUnico';
...
function generatePDF() {
    ...
    doc.setFontSize(12);
    doc.text('Reporte de Alumnos Solicitando el Certificado Unico de Calificaciones', 12, y + imgHeight + 10);
    ...
    // Save the PDF
    doc.save('reporte_certificado_UnicoCalificacion.pdf');
}
</script>
