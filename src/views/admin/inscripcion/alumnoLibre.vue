<template>
    <div class="card">
        <h4 style="color: blue; text-align: center;">INSCRIPCION DE ALUMNOS LIBRES</h4><br><br>
...
import { alumnosLibre } from '../js/alumnoLibre';
...
function generatePDF() {
    ...
    doc.setFontSize(12);
    doc.text('Reporte de Alumnos Libres', 12, y + imgHeight + 10);
    ...
    // Save the PDF
    doc.save('reporte_alumonLibre.pdf');
}
</script>
