    ...
    <div class="layout-main-container">
        <div class="col-12 mb-2 lg:col-11 lg:mb-0">
            <div class="card">
                ...
                <ListaArchivos :valueArchivos="valueArchivos1" :nomArchivos="nomArchivos1" :tabla="'designacion_tribunal'"
...
const valueArchivos1 = ref(["solicitud_tribunal"]);

const nomArchivos2 = ref(['2. Proyecto de Resolucion de Designacion de Tribunal de Grado']);
const valueArchivos2 = ref(["proyecto_resolucion_tribunal"]);
