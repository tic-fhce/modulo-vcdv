    ...
    <div class="layout-main-container">
        <div style="width: 80%;">
            <div class="card">
                ...
                <ListaArchivos ref="valRef" :valueArchivos="valueArchivos" :nomArchivos="nomArchivos" :tabla="'designacion_tribunal'"/>
                <br><br>
                <div>
...
const nomArchivos = ref(['1. Resolucion de tribunal de grado']);
const valueArchivos = ref(["resolucion_tribunal"]);
