  ...
  <div class="">
    <div class="documentos">
      <DataTable :value="documentosTabla" :paginator="false">
        <Column field="archivo" :header="nomDivision" style="width: 18%;"></Column>
        <Column header="DOCUMENTO" style="width: 18%;">
          <template #body="{ data }">
        ...
        <Column v-if="mostrarColumnaObservaciones && mostrarObservaciones" field="observaciones" header="OBSERVACIONES" style="width: 18%;">
          <template #body="{ data }">
            <p v-if="data.observaciones">{{ data.observaciones }}</p>
          </template>
        </Column>

        <Column header="REVISION" v-if="mostrarRevision" style="width: 18%;">
          <template #body="{ data }">
        ...
        <Column field="errores" header="ERRORES" v-if="mostrarRevision" style="width: 18%;">
          <template #body="{ data }">
