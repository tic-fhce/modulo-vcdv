    ...
    <div class="layout-main-container">
        <div style="width: 80%;">
            <div class="card">
                ...
                <ListaArchivos :key="listaArchivosKey" :valueArchivos="valueArchivos" :nomArchivos="nomArchivos" :tabla="'conv_doc_interinos'"
                    :nom-division="'CERTIFICACION PERSONAL DOCENTE'" :mostrar-observaciones-prop="true" /><br>
...
const documentos = ref([
    { nombre: '1. Convocatoria concurso de meritos', value: 'convocatoria', url: '', activo: true},
...
watch(obs, (newVal) => {
    if (newVal) {
        nomArchivos.value.push("2. Convocatoria concurso de meritos");
