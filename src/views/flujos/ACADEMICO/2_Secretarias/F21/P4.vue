...
const documentos = [
    { nombre: '1. Proyecto de Resolucion de Perfil de Grado', archivo: 'F21 D1 PROYECTO RESOLUCION CAMBIO.docx', value: 'proyecto_resolucion_perfil', url: '' },
    { nombre: '2. Solicitud de aprobacion de Proyecto de Resolucion', archivo: 'F21 D2 SOLICITUD CAMBIO.docx', value: 'solicitud_aprobacion_perfil', url: '' }
];
