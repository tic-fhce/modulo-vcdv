...
import convocatoriaService from '@/services/convDocContratados.service'
...
const documentosDisponibles = [ { name: 'DOCENTE(S) INVESTIGADOR(ES) INTERINO(S)', code: 'F12 CONVOCATORIA DOCENTES CONTRATADOS.docx' } ];
...
const documentos = ref([
    ...
    { nombre: '2. Nota de atención', archivo: 'F12 D1 NOTA ATENCION.docx', value: 'nota_atencion', url: '', activo: false }
]);
