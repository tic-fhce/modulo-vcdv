    ...
    <div class="layout-main-container">
        <div style="width: 80%;">
            <div class="card">
                ...
                <ListaArchivos :valueArchivos="valueArchivos" :nomArchivos="nomArchivos" :tabla="'conv_doc_contratados'"
...
const documentos = [
    { nombre: '1. Certificacion de carga horaria', archivo: 'F12 D2 CERTIFICACION CARGA HORARIA.docx', value: 'certificacion_carga_horaria', url: '', activo: true }
]
