        ...
        <div style="width: 80%;">
            <div class="card">
                ...
                <ListaArchivos ref="valRef" :valueArchivos="valueArchivos" :nomArchivos="nomArchivos"
                    :mostrarObservacionesProp="true" :mostrarRevision="true" :nomDivision="'DOCUMENTOS'" :tabla="'conv_doc_contratados'" />
                <br><br>

                <ListaArchivos :valueArchivos="valueArchivos2" :nomArchivos="nomArchivos2"
                    :mostrarFirmarDoc="true" :mostrarVFirma="true" :nomDivision="'ATENCIÓN AL TRÁMITE'" :tabla="'conv_doc_contratados'" />
                <br><br>
