        ...
        <div class="col-12 mb-2 lg:col-11 lg:mb-0">
            <div class="card">
                ...
                <ListaArchivos :key="listaArchivosKey" :valueArchivos="valueArchivos"
                    :nomArchivos="nomArchivos" :tabla="'aprobacion_perfil'" :nomDivision="'DOCUMENTOS DE APROBACION DE PERFIL'" />
...
const documentos = [
    { nombre: '1. Resolucion de Perfil de Grado', archivo: 'F18 D3 RESOLUCION PERFIL DE GRADO.docx', value: 'resolucion_perfil', url: ''}
]

const nomArchivos = ref(['1. Proyecto de Resolucion de Perfil de Grado', '2. Solicitud de aprobacion de Proyecto de Resolucion']);
const valueArchivos = ref(["proyecto_resolucion_perfil", "solicitud_aprobacion_perfil"]);
