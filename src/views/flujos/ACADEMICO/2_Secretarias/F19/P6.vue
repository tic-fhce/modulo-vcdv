        ...
        <div class="col-12 mb-2 lg:col-11 lg:mb-0">
            ...
            <div class="card">
                ...
                <ListaArchivos :key="listaArchivosKey" :valueArchivos="valueArchivos"
                    :nomArchivos="nomArchivos" :tabla="'cambio_modalidad'" :nomDivision="'DOCUMENTOS DE APROBACION DE CAMBIO'" />
...
const documentos = [
    { nombre: '1. Resolucion de Perfil de Grado', archivo: 'F19 D3 RESOLUCION CAMBIO.docx', value: 'resolucion_perfil', url: ''}
]
