    ...
    <div class="layout-main-container">
        <div style="width: 80%;">
            <div class="card">
                ...
                <ListaArchivos :key="listaArchivosKey" :valueArchivos="valueArchivos" :nomArchivos="nomArchivos" :tabla="'conv_aux_docencia'"
                    :nom-division="'CERTIFICACION BIENESTAR SOCIAL'" :mostrar-observaciones-prop="true" :mostrar-v-firma="true" /><br>
...
const documentos = ref([
    { nombre: '1. Convocatoria Auxiliar de Docencia', value: 'convocatoria', url: '', activo: true},
    { nombre: '2. Nota de atención',  value: 'nota_atencion', url: '', activo: true }
]);
...
onMounted(async () => {
    obs.value = datosrecividos.observaciones;
});

watch(obs, (newVal) => {
    if (newVal) {
        nomArchivos.value.push("2. Convocatoria Auxiliar de Docencia");
        valueArchivos.value.push("convocatoria");
