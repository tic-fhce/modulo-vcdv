<template>
    ...
    <div class="layout-main-container">
        <div style="width: 80%;">
            <div class="card">
                <AppDatos :active="true" :titulo="'CONVOCATORIA DE AUXILIARES DE DOCENCIA'"></AppDatos>

                <ListaArchivos :valueArchivos="valueArchivos" :nomArchivos="nomArchivos" :tabla="'conv_aux_docencia'"
...
const documentos = [
    { nombre: '1. Certificacion de carga horaria', archivo: 'F14 D2 CERTIFICACION CARGA HORARIA.docx', value: 'certificacion_carga_horaria', url: '', activo: true }
]

const nomArchivos = ref(['1. Convocatoria Auxiliares de Docencia']);
