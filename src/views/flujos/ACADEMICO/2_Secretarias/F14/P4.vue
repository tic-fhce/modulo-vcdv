        ...
        <div style="width: 80%;">
            <div class="card">
                ...
                <ListaArchivos ref="valRef" :valueArchivos="valueArchivos" :nomArchivos="nomArchivos"
                    :mostrarRevision="true" :nomDivision="'DOCUMENTOS'" :tabla="'conv_aux_docencia'"
                    :mostrar-v-firma="true" />
                <br><br>

                <ListaArchivos :valueArchivos="valueArchivos2" :nomArchivos="nomArchivos2" :mostrarFirmarDoc="true"
                    :mostrarVFirma="true" :nomDivision="'ATENCIÓN AL TRÁMITE'" :tabla="'conv_aux_docencia'" />
                <br><br>
                ...
                try {
                    ...
                    const enviarSolicitud = async (index) => {
                        if (index < tb.length) {
                            ...
                            const dat = { columna: valueArchivos.value[index], observacion: obs, nrotramite: nt, tabla: 'conv_aux_docencia' };
