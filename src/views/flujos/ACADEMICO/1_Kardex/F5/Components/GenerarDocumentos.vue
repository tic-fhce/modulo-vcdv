<template>
    <Toast />
    <h5>GENERAR EL CERTIFICADO Y LLENAR</h5>
...
import { handleUpload, handleUrl, handleDownload } from './driveServiceCertificadoUnico';
...
const tablaBD = "certificado_unico";
...
async function downloadDocument(data) {
    ...
    try {
        ...
        await certificadoUnicoService.actulizarColumna(datAct);
