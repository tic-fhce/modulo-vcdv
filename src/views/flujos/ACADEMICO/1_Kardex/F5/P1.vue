...
const nomArchivos = ['valorada', 'cedula_identidad']
const nomdocumentos = ['1. Valorada del Certificado', '2. Cedula de Identidad'];
                    ...
                    const enviarSolicitud = async (index) => {
                        if (index < imagenesSeleccionadas.length) {
                            ...
                            if (imagen && imagen.value !== null) {
                                ...
                                formData.append('tabla', 'certificado_unico')
