    ...
    <div class="layout-main-container">
        <div style="width: 80%;">
            <div class="card">
                ...
                <ListaArchivos :valueArchivos="valueArchivos" :nomArchivos="nomArchivos" :tabla="'certificado_unico'"
...
const documentos = [
    { nombre: '1. Certificado Unico de Calificaciones', archivo: 'F5 D1 CERTIFICADO UNICO.docx', value: 'certificado_unico', url: '' }
]
