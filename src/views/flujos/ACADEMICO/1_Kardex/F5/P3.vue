    ...
    <div class="layout-main-container">
        <div style="width: 80%;">
            <div class="card">
                ...
                <ListaArchivos :swfirmar="true" :docfirma="'certificado_unico'" :valueArchivos="valueArchivos" :nomArchivos="nomArchivos" :tabla="'certificado_unico'"/>
...
const nomArchivos = ["1. Certificado Unico de Calificaciones"];
