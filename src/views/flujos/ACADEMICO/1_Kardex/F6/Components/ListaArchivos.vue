  ...
  <div class="">
    <div class="documentos">
      <DataTable :value="documentosTabla" :paginator="false">
        ...
        <Column header="FIRMAR" v-if="swfirmar">
          <template #body="{ data }">
            <Button v-if="data.enlaces[0].nombre === docfirma" @click="irAFirmar()" severity="info"><i class="pi pi-pencil">
                Firmar</i></Button>
          </template>
        </Column>
...
const swfirmar = ref(false)
const docfirma = ref(null)
