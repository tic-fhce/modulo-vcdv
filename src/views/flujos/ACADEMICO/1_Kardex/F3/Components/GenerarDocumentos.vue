...
import { handleUpload, handleUrl, handleDownload } from './driveServiceConvalidacion01';
...
const tablaBD = "convalidacion_01";
...
async function downloadDocument(data) {
    ...
    try {
        ...
        await convalidacion01Service.actulizarColumna(datAct);
