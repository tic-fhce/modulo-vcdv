        ...
        <div style="width: 80%;">
            <div class="card">
                ...
                <ListaArchivos :valueArchivos="valueArchivos2" :nomArchivos="nomArchivos2" :tabla="'convalidacion_02'"
                    :mostrarVFirma="true" :nom-division="'DOCUMENTOS ADJUNTOS AL TRAMITE'" />
                <br><br>
...
const valueArchivos2 = ["informe_convalidacion", "proy_resolucion", "resolucion"];
const nomArchivos2 = ['1. Informe de convalidación', '2. Proyecto de Resolución', '3. Resolución de Convalidación'];
