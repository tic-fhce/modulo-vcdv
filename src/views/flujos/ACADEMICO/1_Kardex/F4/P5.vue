...
const documentos = [
    { nombre: '1. Proyecto de Resolución', archivo: 'F4 D2 PROYECTO RESOLUCION.docx', value: 'proy_resolucion', url: '' }
]
...
const valueArchivos2 = ["informe_convalidacion"];
const nomArchivos2 = ['1. Informe de convalidación'];
