...
const nomArchivos = ["nota_director", "formulario_convalidacion", "cedula_identidad", "record_academico_carrera_origen", "contenidos_analiticos"]
const nomdocumentos = ['1. Nota dirigida al Director', '2. Formulario de Convalidacion', '3. Cedula de Identidad', '4. Record Academico de la Carrera y Universidad que viene', '5. Contenidos Analiticos'];
                    ...
                    const enviarSolicitud = async (index) => {
                        if (index < imagenesSeleccionadas.length) {
                            ...
                            if (imagen && imagen.value !== null) {
                                ...
                                formData.append('tabla', 'convalidacion_02')
