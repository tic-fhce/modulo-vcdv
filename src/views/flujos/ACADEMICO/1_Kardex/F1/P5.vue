...
const documentos = [{ archivo: '1. Proyecto de resolucion de alumno libre', url: urlDoc, tipo: 'proy_resolucion' }]
...
async function downloadDocument() {
    loading.value = true
    try {
        const message = await handleDownload(datosrecividos.nrotramite, 'c_proy_resolucion', 'proy_resolucion', datosrecividos.flujo, 'alumno_libre');
        alert(message);
    } finally {
        loading.value = false
    }
