    ...
    <div class="layout-main-container">
        <div style="width: 80%;">
            <div class="card">
                ...
                <ListaArchivos ref="valRef" :valueArchivos="valueArchivos" :nomArchivos="nomArchivos" :tabla="'materia_extra'"/>
                <br><br>
...
const nomArchivos = ref(['1. Aval de Aprobacion']);
const valueArchivos = ref(["aval"]);
