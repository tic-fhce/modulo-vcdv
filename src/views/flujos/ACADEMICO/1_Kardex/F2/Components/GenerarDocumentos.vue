...
import { handleUpload, handleUrl, handleDownload } from './driveServiceMateriaExtra';
...
async function downloadDocument(data) {
    ...
    try {
        ...
        await materiaExtraService.actulizarColumna(datAct);
